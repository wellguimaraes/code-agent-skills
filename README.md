...
| `squash-and-merge` | Squash-merge a GitHub pull request with gh, with an explicit conventional-commit subject and simple-English body instead of the GitHub default message. |
